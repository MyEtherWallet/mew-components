<template>
  ...
  -->
          <div v-else class="d-flex flex-column currency-symbol">
            <img :src="notification.fromObj.icon" width="30px" height="30px" />
            <img
          ...
          <div class="ml-5 detail-container full-width">
            <div v-if="!isSwap">
              <div class="caption font-weight-medium d-flex">
                ...
                <mew-transform-hash :hash="notification.from.value" />
              </div>
              <div class="caption font-weight-medium d-flex">
            ...
            <div v-else>
              <div class="caption font-weight-medium d-flex">
                ...
                <mew-transform-hash :hash="notification.toObj.to" />
              </div>
              <div class="caption mew-heading-2 d-flex">
                {{ notification.fromObj.amount }}
                {{ notification.fromObj.currency }}
                <v-icon class="subtitle-1 ml-1">
                  mdi-arrow-right
                </v-icon>
...
export default {
  ...
  computed: {
    ...
    isSwap() {
      return this.notification.type.toLowerCase() === this.txTypes.swap;
    },
  },
  props: {
    /**
