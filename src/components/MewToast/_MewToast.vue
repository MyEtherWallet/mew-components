      ...
      <v-container fill-height>
        ...
        >
          <div class="d-flex align-center">
            ...
            {{ text }}
            <a @click="onClick" :class="getLinkClasses()"
              >{{ linkObj.title }}
            </a>
            <!--
=====================================================================================
...
const getLinkClasses = () => {
  if (
    toastTypes.value.warning === props.toastType.toLowerCase() ||
    toastTypes.value.info === props.toastType.toLowerCase()
  ) {
    return 'primary--text';
  }
  return 'white--text';
...
const getIcon = () => {
  ...
  if (toastType === toastTypes.value.warning) {
    return 'mdi-alert';
  } else if (toastType === toastTypes.value.success) {
    return 'mdi-check-circle';
  } else if (toastType === toastTypes.value.error) {
