...
In order to show the correct steps and information, you must pass an array of objects to the **items** prop. Each step object is required to have the attributes _step_
(which tells the user which step it is) and _name_ (which is the title of the step). You may add as many steps as needed. Another prop that is required is **onStep**,
...
<Props of={MewStepper} />
<Preview>
  <Story id='mewstepper--mew-stepper' />
</Preview>
