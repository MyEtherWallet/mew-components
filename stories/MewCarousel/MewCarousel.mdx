...
## Overview
MEW Carousel is used to cycle through different content on a rotating timer (6s). Each slide is customizable by a slot, **slide** + **the number of the slide**, i.e. *slide1*.
...
<Preview><Story id="mewcarousel--mew-carousel" /></Preview>
